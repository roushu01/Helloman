                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        className="text-xs px-3.5 py-2.5 border border-gray-200 dark:border-slate-700 bg-gray-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-lg cursor-not-allowed"
                      />
                    </div>
                  </div>
